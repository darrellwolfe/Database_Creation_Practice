...
Values
(0000001,'Darrell','Wolfe','Storyteller',01/01/1969,'Male','test','testALSO','PO Box 1234','Athol','Idaho','83801',03/02/2022,'Chief Storyteller',1);
*/
...
VALUES
('Darrell', 'Wolfe', 'Storyteller', '01/01/1969', 'Male', 'test', 'testALSO', 'PO Box 1234', 'Athol', 'Idaho', '83801', '03/02/2022', 'Chief Storyteller', 1);
...
(FirstName, LastName, Aliases, DateOfBirth, Gender, Email, PhoneNumber, Address, City, State, PostalCode, HireDate, JobTitle, DepartmentId)
VALUES
('Darrell', 'Wolfe', 'Storyteller', '01/01/1969', 'M', 'test', 'testALSO', 'PO Box 1234', 'Athol', 'Idaho', '83801', '03/02/2022', 'Chief Storyteller', 1);
